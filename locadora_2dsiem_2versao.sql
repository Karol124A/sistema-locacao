CREATE DATABASE  IF NOT EXISTS `locadora_2dsiem_2022` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `locadora_2dsiem_2022`;
...
add column TB_CARGO_SITUACAO varchar (16) default 'ATIVO';

alter table TB_FUNCIONARIO
add column TB_FUNCIONARIO_SITUACAO varchar (16) default 'ATIVO';

alter table TB_CLIENTE
add column TB_CLIENTE_SITUACAO varchar (16) default 'ATIVO';

alter table TB_AUTOMOVEL
add column TB_AUTOMOVEL_SITUACAO varchar (16) default 'ATIVO';

alter table TB_LOCACAO
add column TB_LOCACAO_SITUACAO varchar (16) default 'ATIVO';

alter table TB_MODELO
add column TB_MODELO_SITUACAO varchar (16) default 'ATIVO'; 

alter table TB_MARCA
add column TB_MARCA_SITUACAO varchar (16) default 'ATIVO';
